...
type Generator = Callable[[RealData], ComplexData]
"""
...
type RealGenerator = Callable[[RealData], RealData]
"""
...
type IndexOrName = str | int
"""
Type alias that hopefully declares in a self-explanatory manner the meaning of the or-ed types.
"""
